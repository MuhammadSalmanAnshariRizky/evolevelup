    ...
    <div class="container m-auto ">
        ...
        <div class="card analytics-card status-card border-start-primary mb-4">
            <div class="card-body">
                <div class="analytics-header">
                    ...
                    <div>
                        <h5>Performa Saya</h5>
                        <small class="text-muted">Performa dan penguasaan materi dirangkum per topik dari aktivitas yang
                            telah dikerjakan.</small>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-sm-6 col-xl-4">
                        <div class="analytics-summary-box">
                            ...
                            <div>
                                <small class="text-muted d-block" style="font-size: 15px">Rata-rata Performa</small>
                                <strong class="text-primary fs-3">{{ number_format($averageAccuracy, 2) }}%</strong>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-4">
                        <div class="analytics-summary-box">
                            ...
                            <div>
                                <small class="text-muted d-block" style="font-size: 15px">Rata-rata Penguasaan</small>
                                <strong class="text-success fs-3">{{ number_format($averageMastery, 2) }}%</strong>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-4">
                        <div class="analytics-summary-box">
                            ...
                            <div>
                                <small class="text-muted d-block" style="font-size: 15px">Perlu Diperkuat</small>
                                <strong class="text-danger fs-3">{{ $needsImprovement }}</strong>
                                <small class="text-muted" style="font-size: 15px">topik</small>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form method="GET" action="{{ route('dashboard.siswa') }}">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <select name="subject_id" id="analyticsSubject" class="form-select form-select-sm">
                                        ...
                                        @foreach($analyticsSubjects as $subject)
                                            <option value="{{ $subject->id }}" data-class="{{ $subject->id_class }}" {{ (string) $filterSubjectId === (string) $subject->id ? 'selected' : '' }}>
                                                {{ $subject->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <select name="topic_id" id="analyticsTopic" class="form-select form-select-sm">
                                        ...
                                        @foreach($analyticsTopics as $topic)
                                            <option value="{{ $topic->id }}" data-subject="{{ $topic->id_subject }}" {{ (string) $filterTopicId === (string) $topic->id ? 'selected' : '' }}>{{ $topic->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-md-6 col-lg-3"> <br>
                                    ...
                                    <a href="{{ route('dashboard.siswa') }}" id="resetButton"
                                        class="btn btn-light border btn-sm"><i class="fas fa-undo me-1"></i>Reset</a>
                                </div>
                            </div> <br>
                        </form>
                    </div>
                ...
                @else
                    <p class="fw-bold" style="font-size: 20px">Rekap Penguasaan Topik</p>
                        ...
                        <table id="topicAnalyticsTable" class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @foreach($studentMasteryCollection as $index => $mastery)
                                    ...
                                    @endphp
                                    <tr role="button" data-bs-toggle="modal" data-bs-target="#topicDetailModal-{{ $topicId }}"
                                        ...
                                        <td class="fw-bold">{{ number_format($rowAccuracy, 2) }}<span
                                                class="text-muted fw-normal">/100</span></td>
                                        <td>
                                        ...
                                        <td><span class="badge bg-{{ $recommendationColor }} rounded-pill fw-bold"
                                                style="font-size: 15px">{{ $recommendationLabel }}</span>
                                        </td>
                                        <td class="text-end">
                                            <small class="text-primary fw-semibold" style="font-size: 15px;">Lihat detail <i
                    ...
                    <div class="d-block d-md-none">
                        @foreach($studentMasteryCollection as $mastery)
                            ...
                            @endphp
                            <div class="card topic-card mb-3" role="button" data-bs-toggle="modal"
                                data-bs-target="#topicDetailModal-{{ $topicId }}">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start gap-2 mb-2">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="topic-icon"
                                                style="background:{{ $categoryIconMap['bg'] }};color:{{ $categoryIconMap['fg'] }};">
                                                <i class="bi bi-book"></i>
                                            </div>
                                            <div class="fw-bold">{{ data_get($mastery, 'topic_name', 'Topik') }}</div>
                                        </div>
                                        <span
                                            class="badge bg-{{ $categoryColor }}{{ in_array($categoryColor, ['warning', 'info']) ? ' text-dark' : '' }}">{{ $categoryLabel }}</span>
                                    </div>
                                    <div class="progress mb-1" style="height:8px;">
                                        <div class="progress-bar bg-{{ $categoryColor }}" style="width:{{ $masteryValue }}%;"></div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted">{{ number_format($masteryValue, 2) }}%</small>
                                        <span
                                            class="badge bg-{{ $recommendationColor }}{{ in_array($recommendationColor, ['warning', 'info']) ? ' text-dark' : '' }}">{{ $recommendationLabel }}</span>
                                    </div>
                                    <div class="text-end mt-1"><small class="text-primary fw-semibold">Lihat detail <i
                                                class="bi bi-chevron-right"></i></small></div>
                                </div>
                            </div>
                        @endforeach
                    </div>
                                    ...
                                    @foreach($nilaiList as $index => $n)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge bg-{{ $nilaiColor }}{{ $nilaiColor === 'warning' ? ' text-dark' : '' }}">
                        ...
                        <div class="d-block d-md-none">
                            ...
                            @forelse($nilaiList as $n)
                                ...
                                <div class="card shadow-sm mb-3 border-0"
                                    style="border-left:4px solid var(--bs-{{ $nilaiColorM }}) !important;">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <span
                                                class="badge bg-{{ $nilaiColorM }}{{ $nilaiColorM === 'warning' ? ' text-dark' : '' }}">
        ...
        @foreach($studentMasteryCollection as $mastery)
            ...
            @php
                ...
                /*
                 * =========================================================
                 * AMBIL TAG YANG PERLU DIPERHATIKAN
                 *
                 * Maksimal 3 tag dengan accuracy terendah.
                 * =========================================================
                 */
                ...
                $weakTagNames = $weakTags
                    ->pluck('tag_name')
                    ->map(function ($tag) {

                        /*
                         * Jika tag berbentuk array,
                         * ubah menjadi teks.
                         */
                        if (is_array($tag)) {
                            return collect($tag)
                        ...
                        /*
                         * Ubah menjadi string terlebih dahulu.
                         */
                        $tag = trim((string) $tag);

                        /*
                         * Jika tag berbentuk JSON, misalnya:
                         * ["peluang"]
                         *
                         * decode terlebih dahulu.
                         */
                        $decodedTag = json_decode(
                            $tag,
                            true
                        );
                        ...
                        /*
                         * Jika bukan array atau JSON,
                         * gunakan nilai teks biasa.
                         */
                        return trim(
                            str_replace(
                                ['[', ']', '"'],
                ...
                $formattedTagNames = $formatTagNames(
                    $weakTagNames
                );
                ...
                switch ($recommendationType) {
                    ...
                    case 'penguatan':
                        ...
                        $recommendationText =
                            'Penguasaan kamu pada topik ini masih berada pada kategori '
                            . $categoryLabel
                        ...
                        if ($formattedTagNames !== '') {

                            $recommendationText .=
                                'Yuk, pelajari lagi bagian '
                                . $formattedTagNames
                                . ' serta coba kerjakan lebih banyak latihan agar '
                                . 'pemahamanmu semakin kuat sebelum lanjut ke materi berikutnya.';

                        } else {

                            $recommendationText .=
                                'Yuk, pelajari kembali materi ini dan coba kerjakan '
                                . 'lebih banyak latihan agar pemahamanmu semakin kuat '
                    ...
                    case 'latihan':
                        ...
                        $recommendationText =
                            'Penguasaan kamu pada topik ini berada pada kategori '
                            . $categoryLabel
                            . ', dengan performa sebesar '
                            . number_format(
                                $topicAccuracy,
                        ...
                        if ($formattedTagNames !== '') {
                            ...
                            $recommendationText .=
                                'Coba fokus berlatih pada bagian '
                                . $formattedTagNames
                                . ' agar pemahamanmu terhadap topik ini semakin mantap.';

                        } else {

                            $recommendationText .=
                                'Coba lakukan latihan tambahan agar pemahamanmu '
                                . 'terhadap topik ini semakin mantap.';
                        }
                    ...
                    case 'lanjutan':
                        ...
                        $recommendationText =
                            'Penguasaan kamu pada topik ini sudah berada pada kategori '
                            . $categoryLabel
                            . ', dengan performa sebesar '
                            . number_format(
                                $topicAccuracy,
                        ...
                        if ($formattedTagNames !== '') {
                            ...
                            $recommendationText .=
                                'Pemahamanmu sudah cukup baik, tetapi bagian '
                                . $formattedTagNames
                                . ' masih bisa kamu perkuat lagi. '
                                . 'Coba lakukan beberapa latihan sebelum lanjut ke materi berikutnya.';

                        } else {

                            $recommendationText .=
                                'Pemahamanmu sudah cukup baik. '
                                . 'Pertahankan hasil ini dan lanjutkan ke materi berikutnya.';
                        }
                    ...
                    case 'pengayaan':
                        ...
                        $recommendationText =
                            'Hebat! Penguasaan kamu pada topik ini berada pada kategori '
                            . $categoryLabel
                            . ', dengan performa sebesar '
                            . number_format(
                                $topicAccuracy,
                        ...
                        if ($formattedTagNames !== '') {
                            ...
                            $recommendationText .=
                                ...
                                . 'Kalau ingin semakin siap, kamu juga bisa mencoba '
                                . 'latihan yang lebih menantang pada bagian '
                                . $formattedTagNames
                                . '.';
                            ...
                            $recommendationText .=
                                'Kamu sudah menguasai materi dengan baik. '
                                . 'Yuk, lanjutkan dengan mencoba latihan atau tantangan '
                    ...
                    default:
                        $recommendationText =
                            'Belum ada rekomendasi khusus untuk topik ini.';
                }
            ...
            <div class="modal fade" id="topicDetailModal-{{ $topicId }}" tabindex="-1"
                aria-labelledby="topicDetailModalLabel-{{ $topicId }}" aria-hidden="true">
                    ...
                    <div class="modal-content" style="border-top:4px solid var(--bs-{{ $categoryColor }});">
                        <div class="modal-header">
                            <div>
                                <h5 class="modal-title mb-1" id="topicDetailModalLabel-{{ $topicId }}">
                                    <i
                                        class="bi bi-book text-{{ $categoryColor }} me-2"></i>{{ data_get($mastery, 'topic_name', 'Topik') }}
                                </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="recommendation-box bg-soft-{{ $recommendationColor }}"
                                style="border-left:4px solid var(--bs-{{ $recommendationColor }});">
                                <div class="d-flex align-items-start">
                                    <i class="bi bi-lightbulb-fill text-{{ $recommendationColor }} fs-4 me-3"></i>
                                    <div>
                                        <div class="text-muted mb-2">Rekomendasi Pembelajaran</div>
                                        <span
                                            class="badge bg-{{ $recommendationColor }}{{ in_array($recommendationColor, ['warning', 'info']) ? ' text-bold' : '' }} mb-2">{{ $recommendationLabel }}</span>
                                        <div class="fw-bold">{{ $recommendationText }}</div>
                                    </div>
                                </div>
                            </div> <br>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-12 col-md-6 text-center">
                                    <div class="analytics-box h-100 bg-soft-{{ $categoryColor }}"
                                        style="border-top:3px solid var(--bs-{{ $categoryColor }}) !important;">
                                        <div class="text-muted">Penguasaan Topik</div>
                                        <strong
                                            class="text-{{ $categoryColor }} fs-4">{{ number_format($masteryValue, 2) }}%</strong>
                                        <div class="text-muted mt-2"><strong
                                                class="text-{{ $categoryColor }}">{{ $categoryLabel }}</strong></div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 text-center">
                                    <div class="analytics-box h-100 bg-soft-{{ $accuracyColor }}"
                                        style="border-top:3px solid var(--bs-{{ $accuracyColor }}) !important;">
                                        <div class="text-muted text-center mb-1">Performa</div>
                                        <strong
                                            class="text-{{ $accuracyColor }} fs-4">{{ number_format($topicAccuracy, 2) }}%</strong>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @foreach(['mudah' => 'Mudah', 'sedang' => 'Sedang', 'sulit' => 'Sulit'] as $difficultyKey => $difficultyLabel)
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="difficulty-box h-100"
                                                style="border-left:4px solid var(--bs-{{ $difficultyColor }}) !important;">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <span class="fw-semibold">{{ $difficultyLabel }}</span>
                                                    <strong
                                                        class="text-{{ $difficultyColor }}">{{ number_format($accuracy, 2) }}%</strong>
                                                </div>
                                                <div class="progress mb-1" style="height:8px;">
                                                    <div class="progress-bar bg-{{ $difficultyColor }}"
                                                        style="width:{{ min(100, max(0, $accuracy)) }}%;"></div>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <table class="table table-sm align-middle mb-0">
                                            ...
                                            <tbody>
                                                @foreach($topicActivities as $activity)
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="fw-bold">{{ data_get($activity, 'activity_name', 'Aktivitas') }}
                                                            </div>
                                                            @if($activityType)
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="progress flex-grow-1 me-2" style="height:6px;">
                                                                    <div class="progress-bar bg-{{ $activityColor }}"
                                                                        style="width:{{ min(100, max(0, $accuracy)) }}%;"></div>
                                                                </div>
                                                                <span class="fw-bold text-{{ $activityColor }}"
                                                                    style="min-width:40px;text-align:right;">{{ number_format($accuracy, 0) }}%</span>
                                                            </div>
        ...
        <!-- modal gabung kelas -->
        <div class="modal fade" id="modalGabungKelas" tabindex="-1" aria-labelledby="modalGabungKelasLabel"
            aria-hidden="true">
                ...
                <form method="POST" action="{{ route('student.gabungKelas') }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="small text-muted">Token biasanya diberikan oleh guru. Pastikan memasukkan token
                                dengan
                                benar.</div>
                        </div>
                        <div class="modal-footer">
