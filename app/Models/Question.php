...
class Question extends Model
{
    ...
    protected $fillable = ['tags','hint','type', 'question', 'MC_option', 'SA_answer', 'MC_answer', 'difficulty', 'delta','created_by', 'id_topic'];
    ...
    {
        return $this->hasMany(ActivityAnswer::class, 'id_question');
    }
}
